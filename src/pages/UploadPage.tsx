...
// ===== PERUBAHAN UTAMA DI SINI (key diubah ke snake_case) =====
const documentList = [
...
const UploadsPage = () => {
  ...
  const fetchProfileData = useCallback(async () => {
    // Jangan set loading true di sini agar tidak ada flicker saat refetch
    try {
  ...
  const handleUploadSuccess = () => {
    ...
    // Cukup panggil fetchProfileData untuk memuat ulang data di background
    fetchProfileData();
  };
      ...
      <div className="space-y-4">
        {documentList.map((doc) => (
          <UploadItem
            ...
            // Sekarang pembacaan properti akan berhasil
